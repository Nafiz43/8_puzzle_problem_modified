...
public:
	...
	int heruistic2(state p)
	{
	 ...
	 state* genNextState()
	 {
	 	...
	 	if (f==1)
	 	{
	 		p[0].evaluation_cost=p[0].cost+heruistic1(p[0]);
	 		//p[0].print();
	 	}
	 	else
	 	{
	 	...
	 	if (f==1)
	 	{
	 		p[1].evaluation_cost=p[1].cost+heruistic1(p[1]);
	 		//p[1].print();
	 	}
	 	else
	 	{
	 	...
	 	if (f==1)
	 	{
	 		p[2].evaluation_cost=p[2].cost+heruistic1(p[2]);
	 		//p[2].print();
	 	}
	 	else
	 	{
	 	...
	 	if (f==1)
	 	{
	 		p[3].evaluation_cost=p[3].cost+heruistic1(p[3]);
	 		//p[3].print();
	 	}
	 	else
	 	{
...
public:
	...
	void run_A_star_heruistic1(state src)
	{
		if(goalTest(src))
		{
			cout<<"goal reached"<<endl;
